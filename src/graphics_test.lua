...
function u8g2_bitmap_modes(transparent)
  ...
  disp:drawBox(0, frame_size / 2, frame_size * 5, frame_size)
  disp:drawStr(frame_size / 2, 50, "Black")
  disp:drawStr(frame_size * 2, 50, "White")
  disp:drawStr(frame_size * 7 / 2, 50, "XOR")
  ...
  disp:drawXBM(frame_size * 7 / 2, 24, cross_width, cross_height, cross_bits)
end
